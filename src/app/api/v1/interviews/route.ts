...
export async function POST(request: Request) {
  ...
  const aiName = typeof body.aiName === "string" && body.aiName.trim() ? body.aiName.trim() : "Inluwa AI";
  ...
  const followUpDepth = body.followUpDepth === "LIGHT" || body.followUpDepth === "MODERATE" || body.followUpDepth === "DEEP" ? body.followUpDepth : "LIGHT";
