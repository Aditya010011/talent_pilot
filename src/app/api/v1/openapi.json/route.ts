  ...
  components: {
    securitySchemes: {
      bearerAuth: {
        type: "http",
        scheme: "bearer",
        bearerFormat: "Inluwa AI developer key",
        description:
    ...
    schemas: {
      ...
      Interview: {
        ...
        properties: {
          ...
          aiName: { type: "string", example: "Inluwa AI" },
          aiTone: {
            type: "string",
      ...
      InterviewCreate: {
        ...
        properties: {
          ...
          aiName: { type: "string", default: "Inluwa AI", example: "Alex" },
          aiTone: {
            type: "string",
            enum: ["CASUAL", "PROFESSIONAL", "FORMAL", "FRIENDLY"],
