...
export const metadata = {
  title: "Docs | Inluwa AI",
  description:
    "Learn how to use Inluwa AI — guides for interview creators and interviewees.",
};
    ...
    <>
      ...
      <footer className="border-t border-mk-border/60 px-8 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-xs text-mk-text-muted">
          <span>&copy; {new Date().getFullYear()} Inluwa AI. All rights reserved.</span>
