...
export const faqArticles: DocArticle[] = [
  {
    ...
    categorySlug: "faq",
    title: "General FAQ",
    description: "Common questions about Inluwa AI",
    audience: "both",
    order: 1,
    content: () => (
      <>
        ...
        <h3>Can I use Inluwa AI for free?</h3>
        <p>
          Yes. Inluwa AI is open-source and all features are available without any usage limits. You only need to provide your own AI provider API keys (e.g. OpenAI, Kimi, MiniMax).
        </p>
        ...
        <p>
          Chrome on desktop is recommended for full voice, video, and interactive tool support. Safari and Firefox generally work but may have limitations. Mobile browsers can run Inluwa AI, though a desktop is recommended for critical interviews.
        </p>
        ...
        <p>
          Inluwa AI saves your progress automatically. Return to the same interview link to resume where you left off. The interviewer can also view any data captured before the disconnection.
        </p>
