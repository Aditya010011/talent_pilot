...
export const gettingStartedArticles: DocArticle[] = [
  {
    ...
    content: () => (
      <>
        ...
        <p>
          Inluwa AI is an AI-powered interview platform that conducts structured interviews autonomously. You design an interview, share a link, and Inluwa AI&apos;s AI handles the conversation — asking questions, probing with follow-ups, and generating detailed analysis when the session is complete.
        </p>
