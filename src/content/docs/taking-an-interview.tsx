      ...
      <>
        ...
        <DocSteps>
          <DocStep step={1} title="Open the Link and Enter Your Details">
            <p>Click the interview link to open the Inluwa AI interview page. On the welcome screen, enter your full name and email address, then click <strong>Begin Interview</strong>.</p>
  ...
  },
  {
    ...
    content: () => (
      <>
        ...
        <p>
          Inluwa AI saves your progress automatically. Return to the same interview link, verify your identity if prompted, and continue where you left off — previous answers are preserved.
        </p>
