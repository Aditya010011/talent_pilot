<p align="center">
  <a href="https://kimiyi-ai.com">
    <img src="public/images/marketing/logo.png" alt="Kimiyi AI" width="80" height="80" />
  </a>
</p>

<h1 align="center">Kimiyi AI</h1>
...
<p align="center">
  <a href="https://kimiyi-ai.com">Website</a> &nbsp;·&nbsp;
  <a href="https://youtu.be/Mmn1tjTzuwQ">Video Intro</a> &nbsp;·&nbsp;
  <a href="https://kimiyi-ai.com/docs">Docs</a> &nbsp;·&nbsp;
  <a href="#deployment">Deploy</a>
</p>

<p align="center">
  <a href="https://github.com/1146345502/kimiyi-oss/actions/workflows/ci.yml"><img src="https://github.com/1146345502/kimiyi-oss/actions/workflows/ci.yml/badge.svg?branch=main" alt="CI" /></a>
  <a href="https://github.com/1146345502/kimiyi-oss/releases/latest"><img src="https://img.shields.io/github/v/release/1146345502/kimiyi-oss?color=orange" alt="Latest Release" /></a>
...
<p align="center">
  <a href="https://kimiyi-ai.com">
    <img src="public/images/marketing/hero-screenshots.webp" alt="Kimiyi AI — AI-powered interview platform" width="820" />
  </a>
</p>

<p align="center">
  Design an interview in plain language. Share a link. Kimiyi AI's AI conducts the conversation —<br/>
  asking questions, probing with follow-ups, and generating detailed analysis when the session ends.
</p>

<p align="center">
  <b>
    <a href="https://kimiyi-ai.com">Try Cloud &rarr;</a>
  </b>
  &nbsp;&nbsp;&nbsp;
  <b>
...
## See Kimiyi AI in Action

<p align="center">
  <a href="https://youtu.be/Mmn1tjTzuwQ">
    <img src="https://img.youtube.com/vi/Mmn1tjTzuwQ/maxresdefault.jpg" alt="Kimiyi AI Demo Video" width="720" />
  </a>
  <br/>
...
<p align="center">
  <a href="https://youtu.be/iPZL9aWXp-Q">
    <img src="https://img.youtube.com/vi/iPZL9aWXp-Q/maxresdefault.jpg" alt="Kimiyi AI Product Promotion (Chinese)" width="720" />
  </a>
</p>
</details>
...
Kimiyi AI is an AI-powered interview platform that conducts structured interviews autonomously. You design an interview, share a link, and Kimiyi AI's AI handles the conversation — asking questions, probing with follow-ups, and generating detailed analysis when the session is complete.
...
You can use Kimiyi AI as a managed cloud service or self-host the entire platform on your own infrastructure.

### Cloud Hosted

The fastest way to get started. No setup required — sign up and start creating interviews immediately.

**[Get started at kimiyi-ai.com &rarr;](https://kimiyi-ai.com)**
...
Run Kimiyi AI on your own servers for full control over data, configuration, and customization.
...
```bash
git clone https://github.com/1146345502/kimiyi-oss.git
cd kimiyi-oss
npm install
```
...
- **Google Cloud credentials** for STT/TTS (either via `GOOGLE_APPLICATION_CREDENTIALS_JSON` string or `GOOGLE_APPLICATION_CREDENTIALS` file path)
...
Kimiyi AI uses a pluggable LLM provider architecture. You need **at least one** provider configured. The system auto-selects the first available provider in this order: OpenAI > Kimi > MiniMax.
...
Kimiyi AI uses LLMs for four distinct tasks, each selecting the best available model:
...
Kimiyi AI supports real-time AI voice interviews via WebSocket relay servers. Two relay implementations are provided.
...
Kimiyi AI includes a full REST API for programmatic access to interviews, questions, sessions, and candidates. Use it to integrate Kimiyi AI into your existing workflows, automate interview creation, or build custom integrations.
...
<p align="center">
  <sub>Built by <a href="https://kimiyi-ai.com">AuraTerra Nexus</a> — Every voice heard, every insight captured.</sub>
</p>
